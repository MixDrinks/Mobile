...
@Composable
fun PlaceHolder(placeHolder: ListComponent.CocktailsListState.PlaceHolder, component: ListComponent) {
  Box(
      modifier = Modifier
          .fillMaxWidth()
          .fillMaxHeight(),
...
@Composable
fun CocktailList(cocktails: ListComponent.CocktailsListState.Cocktails, component: ListComponent) {
  LazyColumn {
